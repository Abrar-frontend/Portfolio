    ...
    <>
        <div className='w-full pb-36 pt-24 box-border' style = {ColorObj}>
            ...
            <div className='relative lg:left-64 left-4 h-96 mt-5 ' style = {{zIndex:'-10'}}>
                ...
                <div className=" mt-12 md:mt-20 ms-2 sm:ms-20 h-96 w-72 sm:w-96 flex flex-col gap-4 justify-center items-center shadow-lg  relative" style = {{backgroundColor:"rgb(247, 241, 236)",zIndex:'-10'}}>
                ...
                {/* Card footer div */}
                <div className=" ms-2 sm:ms-20 w-96 h-16 bg-white relative w-72 sm:w-96 " style = {{zIndex:'-10'}}>
